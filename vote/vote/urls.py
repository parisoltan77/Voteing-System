...
urlpatterns = [
    ...
    path('candidateprofile/<int:id>/', views.candidateProfileView, name='candidateprofile'),
    path('candidateprofile/<int:id>/candidateedit',views.candidateEditView,name = 'candidateedit'),
